// https://github.com/video-react/video-react/blob/master/src/components/control-bar/SeekBar.js
import PropTypes from 'prop-types';
import React, { Component } from 'react';
import classNames from 'classnames';
import {LoadProgressBar, MouseTimeDisplay, Slider} from "video-react";
...
export default class SeekBar extends Component {
    ...
    render() {
        const { player: { currentTime, seekingTime, duration, buffered }, mouseTime, renderUnderlay } = this.props;
        const time = seekingTime || currentTime;
        return (
            <Slider
                ref={(input) => {
            ...
            >
                ...
                <MouseTimeDisplay
                    ...
                    mouseTime={mouseTime}
                />
                {renderUnderlay(mouseTime, this.props)}
                <PlayProgressBar
                    currentTime={time}
                    duration={duration}
                />
